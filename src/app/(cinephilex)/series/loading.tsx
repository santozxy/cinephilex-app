    ...
    <main className="flex flex-col gap-8 justify-center items-center ">
      ...
      <section className="mx-10">
        <div className="flex gap-2 items-center">
          ...
          <h1 className="text-lg font-bold my-6 ">Comédia</h1>
        </div>
      ...
      <section className="mx-10">
        <div className="flex gap-2 ">
          <Film size={24} className="text-primary" />
          <h1 className="text-2xl font-bold my-6 ">Mistério</h1>
        </div>
        <div className="flex flex-wrap gap-2 justify-center">
          <Carousel>
            <CarouselContent>
      ...
      <section className="mx-10">
        <div className="flex gap-2 items-center">
          <Tv size={24} className="text-primary" />
          <h1 className="text-2xl font-bold my-6 ">Melhor Avaliados</h1>
        </div>
        <div className="flex flex-wrap gap-2 justify-center">
          <Carousel>
            <CarouselContent>
